...
public class PlayerInfoView extends JPanel implements Observer {
    ...
    // Mapa de cores para jogadores
    private static final Map<PlayerColor, Color> playerColors = new HashMap<>();

    static {
        playerColors.put(PlayerColor.VERMELHO, new Color(220, 20, 60));
        playerColors.put(PlayerColor.AZUL, new Color(30, 144, 255));
        playerColors.put(PlayerColor.VERDE, new Color(34, 139, 34));
        playerColors.put(PlayerColor.AMARELO, new Color(255, 215, 0));
        playerColors.put(PlayerColor.BRANCO, Color.WHITE);
        playerColors.put(PlayerColor.PRETO, Color.BLACK);
